define([
	...
	var MODE_DIRECT=0, MODE_ALPHA=1; // !! This is only being set here to get the below code to work w/o needed the global variable. Should be put into some sort of required config object.
...
// Return Object 'bundle' of functions.
// This should maybe be refatored into separate modules &/or have some sort of greater structure.
	return {
		boundLog: boundLog,
		setDisplayProperty: setDisplayProperty,
		setColorBrewer: setColorBrewer,
		setColorGradient: setColorGradient,
		setProperty: setProperty,
		setPropertyBrewer: setPropertyBrewer,
		buildAlpha: buildAlpha,
		playAlpha: playAlpha,
		setupDataInterval: setupDataInterval,
		removeMaps: removeMaps,
		setMarker: setMarker,
		pauseSlider: pauseSlider,
		playSlider: playSlider,
		changeSlider: changeSlider,
		initAlphaMode: initAlphaMode,
		init3ViewsMode: init3ViewsMode,
